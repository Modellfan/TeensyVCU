...
#define CMU_CRC_ERROR_THRESHOLD 3                    
...
#define CONTACTOR_TIMEOUT 1000
#define CONTACTOR_DEBOUNCE 100 //Debounce should be bigger than time loop

#define CONTACTOR_CLOSED_STATE LOW

#define CONTACTOR_PRECHARGE_STRATEGY_TIMED_DELAY 0
#define CONTACTOR_PRECHARGE_STRATEGY_VOLTAGE_MATCH 1
#define CONTACTOR_PRECHARGE_STRATEGY_DEFAULT CONTACTOR_PRECHARGE_STRATEGY_TIMED_DELAY

#define CONTACTOR_PRECHARGE_VOLTAGE_TOLERANCE 5.0f
#define CONTACTOR_PRECHARGE_MATCH_TIMEOUT_MS 2000UL
#define CONTACTOR_PACK_VOLTAGE_VALIDITY_MS 500UL
